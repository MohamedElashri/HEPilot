...
\[TWiki\](https://twiki.cern.ch/twiki/bin/view/Main/WebHome)\\\>\![\](./LHCbTCK
\_ LHCb \_ TWiki_files/web-bg-small.gif) \[LHCb
Web\](https://twiki.cern.ch/twiki/bin/view/LHCb/WebHome)\\\>\[LHCbTCK\](https://twiki.cern.ch/twiki/bin/view/LHCb/LHCbTCK
\"Topic revision: 7 (2018-08-23 - 22:41:12)\") (2018-08-23,
\[MichaelKentWilkinson\](https://twiki.cern.ch/twiki/bin/edit/Main/MichaelKentWilkinson?topicparent=LHCb.LHCbTCK;nowysiwyg=1
\"this topic does not yet exist; you can create it.\"))
\[\![\](./LHCbTCK \_ LHCb \_ TWiki_files/uweb-o14.gif)
Edit\](https://twiki.cern.ch/twiki/bin/edit/LHCb/LHCbTCK?t=1762217711;nowysiwyg=1
\"Edit this topic
text\")\[Attach\](https://twiki.cern.ch/twiki/bin/attach/LHCb/LHCbTCK
\"Attach an image or document to this
topic\")\[PDF\](https://twiki.cern.ch/twiki/bin/genpdf/LHCb/LHCbTCK
\"Create a PDF file for the topic\")

LHCb \[TCK\](https://twiki.cern.ch/twiki/bin/view/LHCb/TCK) pages
===============================================================

This page contains the procedure to follow when an existing
\[TCK\](https://twiki.cern.ch/twiki/bin/view/LHCb/TCK) (L0 & HLT) needs
to be modified:

\* \[Uploading a new L0 TCK into the hardware via
PVSS\](https://twiki.cern.ch/twiki/bin/view/LHCb/L0TCKPVSS) \* \[Release
the L0TCK
package\](https://twiki.cern.ch/twiki/bin/edit/LHCb/L0TCK?topicparent=LHCb.LHCbTCK;nowysiwyg=1
\"this topic does not yet exist; you can create it.\") \* \[How to
generate a L0 Muon recipe corresponding to a FOI in a given
TCK\![\](./LHCbTCK \_ LHCb \_
TWiki_files/external-link.gif)\](https://lbtwiki.cern.ch/bin/view/L0/L0MuonHowToGenrateTCKRecipes)
\* \[Modify the HLT
TCK\](https://twiki.cern.ch/twiki/bin/view/LHCb/HLTTCK) \* \[Removing a
TCK (made with
createTCKEntries)\](https://twiki.cern.ch/twiki/bin/view/LHCb/RemoveTCK)
\* \[Required configurations for each version of Moore (including for
technical
triggers)\](https://twiki.cern.ch/twiki/bin/view/LHCb/ConfigurationsTCK)
\* \[Create and use a private
TCK\](https://twiki.cern.ch/twiki/bin/view/LHCb/PrivateTCK) \* \[Making
a MC version of a TCK\](https://twiki.cern.ch/twiki/bin/view/LHCb/MCTCK)
\* \[How do I run the HLT2 without PID
selections?\](https://twiki.cern.ch/twiki/bin/view/LHCb/HltFAQ#How_do_I_run_the_HLT2_without_PI)

N.B. After the release of the new
\[L0TCK\](https://twiki.cern.ch/twiki/bin/edit/LHCb/L0TCK?topicparent=LHCb.LHCbTCK;nowysiwyg=1
\"this topic does not yet exist; you can create it.\") package, it may
be some time before the Savannah deployment task may be executed. In
case a fix is required immediately in the pit, it will be necessary to
install the updated
\[L0TCK\](https://twiki.cern.ch/twiki/bin/edit/LHCb/L0TCK?topicparent=LHCb.LHCbTCK;nowysiwyg=1
\"this topic does not yet exist; you can create it.\") package in the
Moore satellite area. However, the monitoring tasks running in the
monitoring farm will not (yet) know about the new L0
\[TCK\](https://twiki.cern.ch/twiki/bin/view/LHCb/TCK).

\\\--
\[EricvanHerwijnen\](https://twiki.cern.ch/twiki/bin/view/Main/EricvanHerwijnen) -
11-May-2010
...
version\](https://twiki.cern.ch/twiki/bin/view/LHCb/LHCbTCK?cover=print
\"Printable version of this
topic\") \| \[History\](https://twiki.cern.ch/twiki/bin/oops/LHCb/LHCbTCK?template=oopshistory
\"View total topic history\"):
r7 \[\<\](https://twiki.cern.ch/twiki/bin/rdiff/LHCb/LHCbTCK?rev1=7;rev2=6) \[r6\](https://twiki.cern.ch/twiki/bin/view/LHCb/LHCbTCK?rev=6) \[\<\](https://twiki.cern.ch/twiki/bin/rdiff/LHCb/LHCbTCK?rev1=6;rev2=5) \[r5\](https://twiki.cern.ch/twiki/bin/view/LHCb/LHCbTCK?rev=5) \[\<\](https://twiki.cern.ch/twiki/bin/rdiff/LHCb/LHCbTCK?rev1=5;rev2=4) \[r4\](https://twiki.cern.ch/twiki/bin/view/LHCb/LHCbTCK?rev=4) \[\<\](https://twiki.cern.ch/twiki/bin/rdiff/LHCb/LHCbTCK?rev1=4;rev2=3) \[r3\](https://twiki.cern.ch/twiki/bin/view/LHCb/LHCbTCK?rev=3) \| \[Backlinks\](https://twiki.cern.ch/twiki/bin/oops/LHCb/LHCbTCK?template=backlinksweb
\"Search the LHCb Web for topics that link to here\") \| \[Raw
View\](https://twiki.cern.ch/twiki/bin/view/LHCb/LHCbTCK?raw=on \"View
raw text without
formatting\") \| \[WYSIWYG\](https://twiki.cern.ch/twiki/bin/edit/LHCb/LHCbTCK?t=1762217711;nowysiwyg=0
\"WYSIWYG editor\") \| \[More topic
actions\](https://twiki.cern.ch/twiki/bin/oops/LHCb/LHCbTCK?template=oopsmore&param1=7&param2=7
\"Delete or rename this topic; set parent topic; view and compare
revisions\")

Topic revision: r7 - 2018-08-23
\[\\-\](https://twiki.cern.ch/twiki/bin/edit/LHCb/LHCbTCK?t=1762217711;nowysiwyg=1)
\[MichaelKentWilkinson\](https://twiki.cern.ch/twiki/bin/edit/Main/MichaelKentWilkinson?topicparent=LHCb.LHCbTCK;nowysiwyg=1
\"this topic does not yet exist; you can create it.\")

\![\](./LHCbTCK \_ LHCb \_ TWiki_files/person.gif)
\[YagnaSwaroopDhurbhakula\](https://twiki.cern.ch/twiki/bin/edit/Main/YagnaSwaroopDhurbhakula?topicparent=LHCb.LHCbTCK;nowysiwyg=1
\"this topic does not yet exist; you can create it.\")
\![Lock\](./LHCbTCK \_ LHCb \_ TWiki_files/lock.gif \"Lock\") \[Log
Out\](https://twiki.cern.ch/twiki/bin/view/LHCb/LHCbTCK?logout=1)

\* \[\![Web background\](./LHCbTCK \_ LHCb \_
...
\[\![\](./LHCbTCK \_ LHCb \_ TWiki_files/toggleopen.gif)Public
webs\](https://twiki.cern.ch/twiki/bin/view/LHCb/LHCbTCK#)
\[\![\](./LHCbTCK \_ LHCb \_ TWiki_files/toggleclose.gif)Public
webs\](https://twiki.cern.ch/twiki/bin/view/LHCb/LHCbTCK#)
...
\[AliceEbyE\](https://twiki.cern.ch/twiki/bin/edit/AliceEbyE/WebHome?topicparent=LHCb.LHCbTCK;nowysiwyg=1
\"this topic does not yet exist; you can create it.\") \*
...
platform\](./LHCbTCK \_ LHCb \_ TWiki_files/T-badge-88x31.gif \"This
site is powered by the TWiki collaboration
platform\")\](http://twiki.org/) \[\![Powered by Perl\](./LHCbTCK \_
