...
\[TWiki\](https://twiki.cern.ch/twiki/bin/view/Main/WebHome)\\\>\![\](./LHCbRICH
\_ LHCb \_ TWiki_files/web-bg-small.gif) \[LHCb
Web\](https://twiki.cern.ch/twiki/bin/view/LHCb/WebHome)\\\>\[LHCbRICH\](https://twiki.cern.ch/twiki/bin/view/LHCb/LHCbRICH
\"Topic revision: 86 (2025-05-13 - 16:09:19)\") (2025-05-13,
\[AntonisPapanestis\](https://twiki.cern.ch/twiki/bin/view/Main/AntonisPapanestis))
\[\![\](./LHCbRICH \_ LHCb \_ TWiki_files/uweb-o14.gif)
Edit\](https://twiki.cern.ch/twiki/bin/edit/LHCb/LHCbRICH?t=1762216398;nowysiwyg=1
\"Edit this topic
text\")\[Attach\](https://twiki.cern.ch/twiki/bin/attach/LHCb/LHCbRICH
\"Attach an image or document to this
topic\")\[PDF\](https://twiki.cern.ch/twiki/bin/genpdf/LHCb/LHCbRICH
\"Create a PDF file for the topic\")

\[Public web site\![\](./LHCbRICH \_ LHCb \_
TWiki_files/external-link.gif)\](http://lhcb-public.web.cern.ch/lhcb-public/en/Detector/RICH-en.html)

\[Old page\![\](./LHCbRICH \_ LHCb \_
TWiki_files/external-link.gif)\](http://lhcb-rich.web.cern.ch/lhcb-rich)

LHCb RICH TWiki page ====================

\_Welcome to the LHCb RICH TWiki web page\_

Here are some links to help you quickly navigate:

\* \[RICH
Organization\](https://twiki.cern.ch/twiki/bin/view/LHCb/RICHOrganization)
\* \[Reports and
publications\](https://twiki.cern.ch/twiki/bin/view/LHCb/RichPublications)
\* \[Pictures, figures, and
plots\](https://twiki.cern.ch/twiki/bin/view/LHCb/RICHPicturesAndFigures)
\* \[Official PID
plots\](https://twiki.cern.ch/twiki/bin/view/LHCb/PIDConferencePlots) \*
\[RICH related
conferences\](https://twiki.cern.ch/twiki/bin/view/LHCb/RICHConferences)

RICH meetings \-\-\-\-\-\-\-\-\-\-\-\--

Periodic meetings on the agenda:

\* RICH Operations: every Wednesday in room \[17/1-007\![\](./LHCbRICH
\_ LHCb \_
TWiki_files/external-link.gif)\](http://map.web.cern.ch/map/building?bno=17)
today=new Date() //script alerting on Wednesday thisDay=today.getDay()
if (thisDay==3 && today.getHours()\<18) document.write(\'\<img alt=\" \"
src=\"https://twiki.cern.ch/twiki/pub/TWiki/TWikiDocGraphics/warning.gif\"
/\>\<b\>today!\</b\>\<img alt=\" \"
src=\"https://twiki.cern.ch/twiki/pub/TWiki/TWikiDocGraphics/warning.gif\"
/\>\') \* RICH Software meeting: every week, on Wednesday at 4pm

\[All past and future RICH meetings on CERN Doc Server\![\](./LHCbRICH
\_ LHCb \_
TWiki_files/external-link.gif)\](https://indico.cern.ch/categoryDisplay.py?categId=2l59)

RICH mailing lists \-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\--

\* \[List of all RICH mailing lists\![\](./LHCbRICH \_ LHCb \_
TWiki_files/external-link.gif)\](https://groups.cern.ch/Pages/GroupSearch.aspx?k=lhcb%20rich)
(you can: browse, subscribe, view archieve)

Run 3 topics \-\-\-\-\-\-\-\-\-\-\--

\* \[RICH Operations TWiki\![\](./LHCbRICH \_ LHCb \_
TWiki_files/external-link.gif)\](https://lbtwiki.cern.ch/bin/view/RICH/RICHRun3Operations)
(Commissioning and running the RICH detectors) \* \[Run 3 RICH
TWiki\](https://twiki.cern.ch/twiki/bin/view/LHCb/RichRun3)

Run 1 and Run 2 topics \-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\--

\* \[RICH Software
TWiki\](https://twiki.cern.ch/twiki/bin/view/LHCb/RichSoftware) \*
\[RICH Online Monitor TWiki\![\](./LHCbRICH \_ LHCb \_
TWiki_files/external-link.gif)\](http://lbtwiki.cern.ch/bin/view/RICH/RichOnlineMonitor)
\* \[Previous RICH Operations TWiki\![\](./LHCbRICH \_ LHCb \_
TWiki_files/external-link.gif)\](http://lbtwiki.cern.ch/bin/view/RICH/WebHome)
(Commissioning and running the former RICH detectors) \* \[Run 2
performance\](https://twiki.cern.ch/twiki/bin/view/LHCb/RichRun2Performance)

Testbeam topics \-\-\-\-\-\-\-\-\-\-\-\-\-\--

\* \[Testbeams 2004 and
2005\](https://twiki.cern.ch/twiki/bin/view/LHCb/RichTestbeams2004and2005)
\* \[TestBeam
2006\](https://twiki.cern.ch/twiki/bin/view/LHCb/RichTestBeam2006Analysis)
\* \[RichTestBeam Upgrade
1\](https://twiki.cern.ch/twiki/bin/view/LHCb/RichTestBeam) \*
\[TestBeam 2021 and
2022\](https://twiki.cern.ch/twiki/bin/view/LHCb/RichTestBeam2021)
...
version\](https://twiki.cern.ch/twiki/bin/view/LHCb/LHCbRICH?cover=print
\"Printable version of this
topic\") \| \[History\](https://twiki.cern.ch/twiki/bin/oops/LHCb/LHCbRICH?template=oopshistory
\"View total topic history\"):
r86 \[\<\](https://twiki.cern.ch/twiki/bin/rdiff/LHCb/LHCbRICH?rev1=86;rev2=85) \[r85\](https://twiki.cern.ch/twiki/bin/view/LHCb/LHCbRICH?rev=85) \[\<\](https://twiki.cern.ch/twiki/bin/rdiff/LHCb/LHCbRICH?rev1=85;rev2=84) \[r84\](https://twiki.cern.ch/twiki/bin/view/LHCb/LHCbRICH?rev=84) \[\<\](https://twiki.cern.ch/twiki/bin/rdiff/LHCb/LHCbRICH?rev1=84;rev2=83) \[r83\](https://twiki.cern.ch/twiki/bin/view/LHCb/LHCbRICH?rev=83) \[\<\](https://twiki.cern.ch/twiki/bin/rdiff/LHCb/LHCbRICH?rev1=83;rev2=82) \[r82\](https://twiki.cern.ch/twiki/bin/view/LHCb/LHCbRICH?rev=82) \| \[Backlinks\](https://twiki.cern.ch/twiki/bin/oops/LHCb/LHCbRICH?template=backlinksweb
\"Search the LHCb Web for topics that link to here\") \| \[Raw
View\](https://twiki.cern.ch/twiki/bin/view/LHCb/LHCbRICH?raw=on \"View
raw text without
formatting\") \| \[WYSIWYG\](https://twiki.cern.ch/twiki/bin/edit/LHCb/LHCbRICH?t=1762216398;nowysiwyg=0
\"WYSIWYG editor\") \| \[More topic
actions\](https://twiki.cern.ch/twiki/bin/oops/LHCb/LHCbRICH?template=oopsmore&param1=86&param2=86
\"Delete or rename this topic; set parent topic; view and compare
revisions\")

Topic revision: r86 - 2025-05-13
\[\\-\](https://twiki.cern.ch/twiki/bin/edit/LHCb/LHCbRICH?t=1762216398;nowysiwyg=1)
\[AntonisPapanestis\](https://twiki.cern.ch/twiki/bin/view/Main/AntonisPapanestis)

\![\](./LHCbRICH \_ LHCb \_ TWiki_files/person.gif)
\[YagnaSwaroopDhurbhakula\](https://twiki.cern.ch/twiki/bin/edit/Main/YagnaSwaroopDhurbhakula?topicparent=LHCb.LHCbRICH;nowysiwyg=1
\"this topic does not yet exist; you can create it.\")
\![Lock\](./LHCbRICH \_ LHCb \_ TWiki_files/lock.gif \"Lock\") \[Log
Out\](https://twiki.cern.ch/twiki/bin/view/LHCb/LHCbRICH?logout=1)

\* \[\![Web background\](./LHCbRICH \_ LHCb \_
...
\[\![\](./LHCbRICH \_ LHCb \_ TWiki_files/toggleopen.gif)Public
webs\](https://twiki.cern.ch/twiki/bin/view/LHCb/LHCbRICH#)
\[\![\](./LHCbRICH \_ LHCb \_ TWiki_files/toggleclose.gif)Public
webs\](https://twiki.cern.ch/twiki/bin/view/LHCb/LHCbRICH#)
...
\[AliceEbyE\](https://twiki.cern.ch/twiki/bin/edit/AliceEbyE/WebHome?topicparent=LHCb.LHCbRICH;nowysiwyg=1
\"this topic does not yet exist; you can create it.\") \*
...
\[\![CERN\](./LHCbRICH \_ LHCb \_
TWiki_files/LogoLHCbRICH-140x40.PNG)\](https://twiki.cern.ch/twiki/bin/view/LHCb/WebHome)

\*   

\* \* \![TWiki Search Icon\](./LHCbRICH \_ LHCb \_
TWiki_files/twikisearchicon.gif) TWiki Search \* \![Google Search
Icon\](./LHCbRICH \_ LHCb \_ TWiki_files/googlesearchicon.png) Google
Search
...
platform\](./LHCbRICH \_ LHCb \_ TWiki_files/T-badge-88x31.gif \"This
site is powered by the TWiki collaboration
platform\")\](http://twiki.org/) \[\![Powered by Perl\](./LHCbRICH \_
