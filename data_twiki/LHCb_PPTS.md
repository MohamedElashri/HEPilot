...
\[TWiki\](https://twiki.cern.ch/twiki/bin/view/Main/WebHome)\\\>\![\](./LHCbPPTS
\_ LHCb \_ TWiki_files/web-bg-small.gif) \[LHCb
Web\](https://twiki.cern.ch/twiki/bin/view/LHCb/WebHome)\\\>\[LHCbPPTS\](https://twiki.cern.ch/twiki/bin/view/LHCb/LHCbPPTS
\"Topic revision: 11 (2020-05-20 - 17:07:19)\") (2020-05-20,
\[MichaelAlexander\](https://twiki.cern.ch/twiki/bin/view/Main/MichaelAlexander))
\[\![\](./LHCbPPTS \_ LHCb \_ TWiki_files/uweb-o14.gif)
Edit\](https://twiki.cern.ch/twiki/bin/edit/LHCb/LHCbPPTS?t=1762216857;nowysiwyg=1
\"Edit this topic
text\")\[Attach\](https://twiki.cern.ch/twiki/bin/attach/LHCb/LHCbPPTS
\"Attach an image or document to this
topic\")\[PDF\](https://twiki.cern.ch/twiki/bin/genpdf/LHCb/LHCbPPTS
\"Create a PDF file for the topic\")

\*\*Physics Performance, Trigger, Stripping Approved Plots for
Conference\*\*
=========================================================================

The PPTS meeting has been cancelled and replaced by an Operation report
at the Tuesday meeting. Agenda of the previous meeting on
\[indico\![\](./LHCbPPTS \_ LHCb \_
TWiki_files/external-link.gif)\](https://indico.cern.ch/category/2678/)

Conference Plots \-\-\-\-\-\-\-\-\-\-\-\-\-\-\--

\[Approval procedure for operations plots defined by the
OPG\](https://twiki.cern.ch/twiki/bin/view/LHCbInternal/OperationPlotApproval)

Approved plots (some linked pages should be updated soon):

\* \[Trigger
Plots\](https://twiki.cern.ch/twiki/bin/view/LHCb/LHCbTriggerConferenceDiagramsPlots)

\* \[Tracking and Alignment
Plots\](https://twiki.cern.ch/twiki/bin/view/LHCb/ConferencePlots)
...
version\](https://twiki.cern.ch/twiki/bin/view/LHCb/LHCbPPTS?cover=print
\"Printable version of this
topic\") \| \[History\](https://twiki.cern.ch/twiki/bin/oops/LHCb/LHCbPPTS?template=oopshistory
\"View total topic history\"):
r11 \[\<\](https://twiki.cern.ch/twiki/bin/rdiff/LHCb/LHCbPPTS?rev1=11;rev2=10) \[r10\](https://twiki.cern.ch/twiki/bin/view/LHCb/LHCbPPTS?rev=10) \[\<\](https://twiki.cern.ch/twiki/bin/rdiff/LHCb/LHCbPPTS?rev1=10;rev2=9) \[r9\](https://twiki.cern.ch/twiki/bin/view/LHCb/LHCbPPTS?rev=9) \[\<\](https://twiki.cern.ch/twiki/bin/rdiff/LHCb/LHCbPPTS?rev1=9;rev2=8) \[r8\](https://twiki.cern.ch/twiki/bin/view/LHCb/LHCbPPTS?rev=8) \[\<\](https://twiki.cern.ch/twiki/bin/rdiff/LHCb/LHCbPPTS?rev1=8;rev2=7) \[r7\](https://twiki.cern.ch/twiki/bin/view/LHCb/LHCbPPTS?rev=7) \| \[Backlinks\](https://twiki.cern.ch/twiki/bin/oops/LHCb/LHCbPPTS?template=backlinksweb
\"Search the LHCb Web for topics that link to here\") \| \[Raw
View\](https://twiki.cern.ch/twiki/bin/view/LHCb/LHCbPPTS?raw=on \"View
raw text without
formatting\") \| \[WYSIWYG\](https://twiki.cern.ch/twiki/bin/edit/LHCb/LHCbPPTS?t=1762216857;nowysiwyg=0
\"WYSIWYG editor\") \| \[More topic
actions\](https://twiki.cern.ch/twiki/bin/oops/LHCb/LHCbPPTS?template=oopsmore&param1=11&param2=11
\"Delete or rename this topic; set parent topic; view and compare
revisions\")

Topic revision: r11 - 2020-05-20
\[\\-\](https://twiki.cern.ch/twiki/bin/edit/LHCb/LHCbPPTS?t=1762216857;nowysiwyg=1)
\[MichaelAlexander\](https://twiki.cern.ch/twiki/bin/view/Main/MichaelAlexander)

\![\](./LHCbPPTS \_ LHCb \_ TWiki_files/person.gif)
\[YagnaSwaroopDhurbhakula\](https://twiki.cern.ch/twiki/bin/edit/Main/YagnaSwaroopDhurbhakula?topicparent=LHCb.LHCbPPTS;nowysiwyg=1
\"this topic does not yet exist; you can create it.\")
\![Lock\](./LHCbPPTS \_ LHCb \_ TWiki_files/lock.gif \"Lock\") \[Log
Out\](https://twiki.cern.ch/twiki/bin/view/LHCb/LHCbPPTS?logout=1)

\* \[\![Web background\](./LHCbPPTS \_ LHCb \_
...
\[\![\](./LHCbPPTS \_ LHCb \_ TWiki_files/toggleopen.gif)Public
webs\](https://twiki.cern.ch/twiki/bin/view/LHCb/LHCbPPTS#)
\[\![\](./LHCbPPTS \_ LHCb \_ TWiki_files/toggleclose.gif)Public
webs\](https://twiki.cern.ch/twiki/bin/view/LHCb/LHCbPPTS#)
...
\[AliceEbyE\](https://twiki.cern.ch/twiki/bin/edit/AliceEbyE/WebHome?topicparent=LHCb.LHCbPPTS;nowysiwyg=1
\"this topic does not yet exist; you can create it.\") \*
...
platform\](./LHCbPPTS \_ LHCb \_ TWiki_files/T-badge-88x31.gif \"This
site is powered by the TWiki collaboration
platform\")\](http://twiki.org/) \[\![Powered by Perl\](./LHCbPPTS \_
