...
background-color:#D0D000; } #patternTopBarContents {
background-image:url(/twiki/pub/TWiki/PatternSkin/TWiki\\\_header.gif);
background-repeat:no-repeat;} .patternBookView { border-color:#D0D000; }
...
.twikiTable#table1 {width:75%;} .twikiTable#table1
tr.twikiTableRowdataBg0 td {background-color:#FFFF66;}
.twikiTable#table1 tr.twikiTableRowdataBg1 td
{background-color:#FFFFCC;} .twikiTable#table1 tr.twikiTableRowdataBg0
td.twikiSortedCol {background-color:#FFFF66;} .twikiTable#table1
tr.twikiTableRowdataBg1 td.twikiSortedCol {background-color:#FFFFCC;}
.twikiTable#table1 td.twikiTableCol0 {width:25%;} .twikiTable#table1
th.twikiTableCol0 {width:25%;} .twikiTable#table1 td.twikiTableCol1
{width:25%;} .twikiTable#table1 th.twikiTableCol1 {width:25%;}
.twikiTable#table1 td.twikiTableCol2 {width:25%;} .twikiTable#table1
th.twikiTableCol2 {width:25%;} \@import
...
\[TWiki\](https://twiki.cern.ch/twiki/bin/view/Main/WebHome)\\\>\![\](./WebHome
\_ LHCb_FAQ \_ TWiki_files/web-bg-small.gif) \[LHCb/FAQ
Web\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/WebHome)\\\>\[WebHome\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/WebHome
\"Topic revision: 30 (2023-04-12 - 14:38:06)\") (2023-04-12,
\[ParasNaik\](https://twiki.cern.ch/twiki/bin/view/Main/ParasNaik))
\[\![\](./WebHome \_ LHCb_FAQ \_ TWiki_files/uweb-o14.gif)
Edit\](https://twiki.cern.ch/twiki/bin/edit/LHCb/FAQ/WebHome?t=1762215475;nowysiwyg=1
\"Edit this topic
text\")\[Attach\](https://twiki.cern.ch/twiki/bin/attach/LHCb/FAQ/WebHome
\"Attach an image or document to this
topic\")\[PDF\](https://twiki.cern.ch/twiki/bin/genpdf/LHCb/FAQ/WebHome
\"Create a PDF file for the topic\")

Welcome to LHCb\'s FAQ Pages ===========================

\[Getting Started
FAQ\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/GettingStartedFAQ)

\[LHCb FAQ\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/LHCbFAQ)

\[Brunel FAQ\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/BrunelFAQ)

\[Gauss FAQ\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/GaussFAQ)

\[Bender FAQ\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/BenderFAQ)

\[LoKi FAQ\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/LoKiFAQ)

\[DaVinci
FAQ\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/DaVinciFAQ)
...
\[Test Project\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/TestPage)

\[XMLSummary
FAQ\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/XMLSummaryFAQ)

 

\[Publishing
FAQ\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/PublishingFAQ)

\[CMake FAQ\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/CMakeFAQ)

\[Glossary\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/Glossary)

Search the LHCb FAQ \-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\--

var googleSearchIframeName =
\"results\\\_009951750714794174847:xpypjvuqjf8\"; var
googleSearchFormName =
\"searchbox\\\_009951750714794174847:xpypjvuqjf8\"; var
googleSearchFrameWidth = 600; var googleSearchFrameborder = 0; var
googleSearchDomain = \"www.google.com\"; var googleSearchPath =
\"/cse\";

See also (not yet migrated to this sub web):
\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\--

\* \[LHCb: getting
started\](https://twiki.cern.ch/twiki/bin/view/LHCb/LHCbGettingStartedWiki)
\* \[Working with CMT install
areas\](https://twiki.cern.ch/twiki/bin/view/LHCb/InstallAreaWiki) \*
\[DaVinci
Tutorial\](https://twiki.cern.ch/twiki/bin/view/LHCb/DaVinciTutorial) \*
\[LoKi
Tutorial\](https://twiki.cern.ch/twiki/bin/view/LHCb/LoKiTutorial) \*
\[Panoramix
F.A.Q./manual\](https://twiki.cern.ch/twiki/bin/view/LHCb/PanoRamixWiki)
\* \[GaudiPython
F.A.Q.\](https://twiki.cern.ch/twiki/bin/view/LHCb/GaudiPython) \*
\[Bender
Tutorial\](https://twiki.cern.ch/twiki/bin/view/LHCb/BenderTutorial) \*
\[Running LHCb software on non-supported
platforms\](https://twiki.cern.ch/twiki/bin/view/LHCb/LHCbSoftOnNonSupportedPlatforms)
\* \[Code analysis tools for LHCb
software\](https://twiki.cern.ch/twiki/bin/view/LHCb/CodeAnalysisTools)
\* \[LHCb Conditions Database
How-To\](https://twiki.cern.ch/twiki/bin/view/LHCb/CondDBHowTo) \*
\[LHCbAnalysisBiography\](https://twiki.cern.ch/twiki/bin/view/LHCbPhysics/LHCbAnalysisBiography)

Utilities \-\-\-\-\-\-\-\--

\[To Subscribe to the RSS Feed for this FAQ Click
Here\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/WebRss)

\[To Subscribe to the ATOM Feed for this FAQ Click
Here\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/WebAtom)

\[List of Recent Changes to this
FAQ\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/WebChanges)

\[Subscribe to an e-mail alert sent when FAQ\'s
change\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/WebNotify)

\[\![\](./WebHome \_ LHCb_FAQ \_ TWiki_files/uweb-o14.gif)
Edit\](https://twiki.cern.ch/twiki/bin/edit/LHCb/FAQ/WebHome?t=1762215483;nowysiwyg=1
\"Edit this topic
text\") \| \[Attach\](https://twiki.cern.ch/twiki/bin/attach/LHCb/FAQ/WebHome
\"Attach an image or document to this topic\") \| \[Print
version\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/WebHome?cover=print
\"Printable version of this
topic\") \| \[History\](https://twiki.cern.ch/twiki/bin/oops/LHCb/FAQ/WebHome?template=oopshistory
\"View total topic history\"):
r30 \[\<\](https://twiki.cern.ch/twiki/bin/rdiff/LHCb/FAQ/WebHome?rev1=30;rev2=29) \[r29\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/WebHome?rev=29) \[\<\](https://twiki.cern.ch/twiki/bin/rdiff/LHCb/FAQ/WebHome?rev1=29;rev2=28) \[r28\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/WebHome?rev=28) \[\<\](https://twiki.cern.ch/twiki/bin/rdiff/LHCb/FAQ/WebHome?rev1=28;rev2=27) \[r27\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/WebHome?rev=27) \[\<\](https://twiki.cern.ch/twiki/bin/rdiff/LHCb/FAQ/WebHome?rev1=27;rev2=26) \[r26\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/WebHome?rev=26) \| \[Backlinks\](https://twiki.cern.ch/twiki/bin/oops/LHCb/FAQ/WebHome?template=backlinksweb
\"Search the LHCb/FAQ Web for topics that link to here\") \| \[Raw
View\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/WebHome?raw=on
\"View raw text without
formatting\") \| \[WYSIWYG\](https://twiki.cern.ch/twiki/bin/edit/LHCb/FAQ/WebHome?t=1762215483;nowysiwyg=0
\"WYSIWYG editor\") \| \[More topic
actions\](https://twiki.cern.ch/twiki/bin/oops/LHCb/FAQ/WebHome?template=oopsmore&param1=30&param2=30
\"Delete or rename this topic; set parent topic; view and compare
revisions\")

Topic revision: r30 - 2023-04-12
\[\\-\](https://twiki.cern.ch/twiki/bin/edit/LHCb/FAQ/WebHome?t=1762215483;nowysiwyg=1)
\[ParasNaik\](https://twiki.cern.ch/twiki/bin/view/Main/ParasNaik)

\![\](./WebHome \_ LHCb_FAQ \_ TWiki_files/person.gif)
\[YagnaSwaroopDhurbhakula\](https://twiki.cern.ch/twiki/bin/edit/Main/YagnaSwaroopDhurbhakula?topicparent=LHCb/FAQ.WebHome;nowysiwyg=1
\"this topic does not yet exist; you can create it.\")
\![Lock\](./WebHome \_ LHCb_FAQ \_ TWiki_files/lock.gif \"Lock\") \[Log
Out\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/WebHome?logout=1)

\* \[\![Web background\](./WebHome \_ LHCb_FAQ \_
TWiki_files/web-bg-small.gif \"Web background\")
LHCb/FAQ\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/WebHome)

\* \*\*\[\![Home\](./WebHome \_ LHCb_FAQ \_ TWiki_files/home.gif
\"Home\") LHCb/FAQ
Web\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/WebHome)\*\* \*
\[\![New Topic\](./WebHome \_ LHCb_FAQ \_ TWiki_files/newtopic.png \"New
Topic\") Create New
Topic\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/WebTopicCreator?parent=WebHome)
\* \[\![Index\](./WebHome \_ LHCb_FAQ \_ TWiki_files/index.gif
\"Index\")
Index\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/WebTopicList) \*
\[\![Search\](./WebHome \_ LHCb_FAQ \_ TWiki_files/searchtopic.png
\"Search\")
Search\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/WebSearch) \*
\[\![Changes\](./WebHome \_ LHCb_FAQ \_ TWiki_files/changes.png
\"Changes\")
Changes\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/WebChanges) \*
\[\![Notify\](./WebHome \_ LHCb_FAQ \_ TWiki_files/notify.gif
\"Notify\")
Notifications\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/WebNotify)
\* \[\![Statistics\](./WebHome \_ LHCb_FAQ \_ TWiki_files/statistics.gif
\"Statistics\")
Statistics\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/WebStatistics)
\* \[\![Wrench, tools\](./WebHome \_ LHCb_FAQ \_ TWiki_files/wrench.gif
\"Wrench, tools\")
Preferences\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/WebPreferences)

\* \* \*

\[\![\](./WebHome \_ LHCb_FAQ \_ TWiki_files/toggleopen.gif)Public
webs\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/WebHome#)
\[\![\](./WebHome \_ LHCb_FAQ \_ TWiki_files/toggleclose.gif)Public
webs\](https://twiki.cern.ch/twiki/bin/view/LHCb/FAQ/WebHome#)
...
\[AliceEbyE\](https://twiki.cern.ch/twiki/bin/edit/AliceEbyE/WebHome?topicparent=LHCb/FAQ.WebHome;nowysiwyg=1
\"this topic does not yet exist; you can create it.\") \*
...
platform\](./WebHome \_ LHCb_FAQ \_ TWiki_files/T-badge-88x31.gif \"This
site is powered by the TWiki collaboration
platform\")\](http://twiki.org/) \[\![Powered by Perl\](./WebHome \_
LHCb_FAQ \_ TWiki_files/perl-logo-88x31.gif \"Powered by
